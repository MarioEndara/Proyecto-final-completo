import logo1 from '../../public/images/imagen2.jpg'
...
export const Confirm = () => {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <img className="object-cover h-80 w-80 rounded-full border-4 border-solid border-slate-600" src={logo1} alt="image description"/>
