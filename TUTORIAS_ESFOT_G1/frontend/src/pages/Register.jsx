...
export const Register = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row h-screen">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit(registro)}>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="number" placeholder="Ingresa tu telefono" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" 
            ...
            <div className="w-full sm:w-1/2 h-1/3 sm:h-screen bg-[url('/public/images/imagen3.jpg')] bg-no-repeat bg-cover bg-center sm:block hidden"></div>
        </div>
    );
};
